...
<head>
  <meta charset="UTF-8">
  <title>Login do Responsável</title>
  ...
  <main class="container mx-auto p-6 max-w-md">
    <div class="bg-white rounded-xl shadow p-6">
      ...
      <form method="post" action="${pageContext.request.contextPath}/login" class="space-y-3">
        ...
        <button type="submit" class="w-full px-4 py-2 bg-ufrrj-blue text-white rounded-lg">Login</button>
      </form>
      <div class="mt-3">
        <a href="${pageContext.request.contextPath}/register" class="text-ufrrj-blue underline">Cadastrar responsável</a>
      </div>
